...
class cnnModel(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = torch.nn.Conv1d(in_channels=self.ed,
                                      ...
                                      bias=False,
                                      padding='same')
        self.batchnorm1 = torch.nn.BatchNorm1d(num_features=5)
        ...
        self.layer2 = torch.nn.Conv1d(in_channels=5,
                                      ...
                                      bias=False,
                                      padding='same')
        self.batchnorm2 = torch.nn.BatchNorm1d(num_features=5)
        ...
        self.layer3 = torch.nn.Conv1d(in_channels=5,
                                      ...
                                      bias=False,
                                      padding='same')
        self.batchnorm3 = torch.nn.BatchNorm1d(num_features=5)
        ...
        self.layer4= torch.nn.Conv1d(in_channels=5,
                                      ...
                                      bias=False,
                                      padding='same')
        self.batchnorm4 = torch.nn.BatchNorm1d(num_features=5)
        self.relu4 = torch.nn.ReLU()
        
        #######################################################################
        self.layerOUT = torch.nn.Conv1d(in_channels=5,
                                      out_channels=3,
                                      kernel_size=11,
                                      stride=1,
                                      bias=False,
                                      padding='same')
        self.batchnormOUT = torch.nn.BatchNorm1d(num_features=3)
        self.softMaxOUT = torch.nn.Softmax(dim=1)
    ...
    def forward(self, x):
        ...
        # we want inner product over dim(2), batch mode use '@' matrix mult
