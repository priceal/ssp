...
from model_20250912A import cnnModel
...
print('')
targetLabels = ['H', 'E', 'C']
print('{:<10} {:<10} {:<10}'.format('','label','weight') )
for i,tl in enumerate(targetLabels):
    print('{:<10} {:<10} {:<10}'.format( i, tl, float(weights[i,0]) ) )
...
print('')
print('{:<10} {:<10} {:<10} {:<10}'.format('label','count','fraction','weight') )
for i,tl in enumerate(targetLabels):
    print('{:<10} {:<10} {:<10.5} {:<10.5}'.format(
        tl,labelCounts[i],labelCounts[i]/labelCounts.sum(), float(weights[i,0]) 
        ) )
